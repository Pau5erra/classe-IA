...
public class Move : MonoBehaviour {
	...
	void Update () 
	{
        ...
        //Quaternion.AngleAxis(Mathf.Asin(mov_velocity.z / mov_velocity.magnitude), mov_velocity);

        aim.transform.rotation = Quaternion.AngleAxis(Mathf.Atan2(mov_velocity.x, mov_velocity.z), Vector3.up);
